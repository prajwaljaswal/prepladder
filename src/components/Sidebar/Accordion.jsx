...
const Accordion = ({
  ...
  return (
    <div>
      <div onClick={projectManagementSetting} style={{ fontSize: "16px" }}>{projectManagementHeading}</div>
      ...
      {masterData && projectManagement ? (
        <div className="master-data-list">
          <div className="d-flex gap-2">
            ...
            <div onClick={() => navigate("/searchPage/projectName")}>
              Project Name
            </div>
          </div>
          ...
          <div className="d-flex gap-2">
            ...
            <div onClick={() => navigate("/searchPage/projectStatus")}>
              Project Status
            </div>
          </div>
          ...
          <div className="d-flex gap-2">
            ...
            <div onClick={() => navigate("/searchPage/projectType")}>
              Project Type
            </div>
          </div>
          ...
          <div className="d-flex gap-2">
            ...
            <div onClick={() => navigate("/searchPage/ProjectDomain")}>
              Project Domain
            </div>
          </div>
          ...
          <div className="d-flex gap-2">
            ...
            <div onClick={() => navigate("/searchPage/TechDepartment")}>
              Tech Department
            </div>
          </div>
          ...
          <div className="d-flex gap-2">
            ...
            <div onClick={() => navigate("/searchPage/AddTech")}>
              Tech Stack
            </div>
          </div>
