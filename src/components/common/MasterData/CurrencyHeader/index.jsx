...
import MasterDataTitle from '../MasterDataTitle';
        ...
        <Row>
          ...
          <Col md={6}>
            ...
            <div style={{ marginLeft: '3rem', marginTop: '1rem' }}>
              {fileToShow ? (
                <>
                  <img src={fileToShow} width={100} height={100} alt="preview" />{' '}
                  <MdCancel color="red" style={{ position: 'absolute', marginTop: '-.55rem' }} onClick={clearFile} />
                </>
              ) : (
                ''
              )}
